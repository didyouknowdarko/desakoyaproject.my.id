...
<head>
    ...
    <title>Pelayanan Surat Keterangan Online Kelurahan Koya Kab.Minahasa </title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT KETERANGAN <br> KELURAHAN Koya Kab.Minahasa </h2>
                ...
                <img class="img-responsive wow fadeIn" src="main/images/cta2/cta1-bg.jpg" alt="" data-wow-duration="300ms" data-wow-delay="300ms">
            </div>
        </div>
    </section>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh lurah, kemudian staf akan mencetak surat sesuai request surat yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan di Kantor Kelurahan Koya Kab.Minahasa </p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <section id="contact">
        <div>
            <iframe src="https://maps.google.com/maps?width=100&amp;height=650&amp;hl=en&amp;q=kantor kelurahan koya&amp;t=&amp;z=13&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"  width="100%" height="650px" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" alt="lokasi kelurahan"></iframe>
        </div>
    </section>
    <!--/#bottom-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> KANTOR KELURAHAN KOYA KECAMATAN TONDANO SELATAN KABUPATEN MINAHASA
                </div>
                <div class="col-sm-6">
